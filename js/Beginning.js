class Beginning {
    ...
    display() {
        ...
        this.Seasonbutton.mousePressed(() => {
            ...
            insights.position(displayWidth/2-650, displayHeight/2-300);
            insights.style("fontSize","20px");
            
            
            var nextbutton = createButton("Let's Begin>");
            nextbutton.position(displayWidth/2, displayHeight/2-95)
        ...
        nextbutton.style("fontSize","20px");
            ...
            emailnotification.position(displayWidth/2-650, displayHeight/2-300);
